...
@Component({
  selector: 'app-jurnal-belanja-up-detail-belanja-rincian',
  templateUrl: './jurnal-belanja-up-detail-belanja-rincian.component.html',
  styleUrls: ['./jurnal-belanja-up-detail-belanja-rincian.component.scss']
})
export class JurnalBelanjaUpDetailBelanjaRincianComponent implements OnInit {
  BpkSelected: IBpk;
  title: String;
  showThis: boolean;
  msg: Message[];
