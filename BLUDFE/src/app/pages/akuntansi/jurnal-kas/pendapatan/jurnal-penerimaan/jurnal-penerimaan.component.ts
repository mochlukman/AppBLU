...
@Component({
  selector: 'app-jurnal-penerimaan',
  templateUrl: './jurnal-penerimaan.component.html',
  styleUrls: ['./jurnal-penerimaan.component.scss']
})
export class JurnalPenerimaanComponent implements OnInit, OnDestroy {
