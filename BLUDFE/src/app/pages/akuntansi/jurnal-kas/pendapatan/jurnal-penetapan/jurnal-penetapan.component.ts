...
@Component({
  selector: 'app-jurnal-penetapan',
  templateUrl: './jurnal-penetapan.component.html',
  styleUrls: ['./jurnal-penetapan.component.scss']
})
export class JurnalPenetapanComponent implements OnInit {
