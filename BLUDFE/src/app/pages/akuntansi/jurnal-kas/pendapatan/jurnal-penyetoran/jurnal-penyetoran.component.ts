...
@Component({
  selector: 'app-jurnal-penyetoran',
  templateUrl: './jurnal-penyetoran.component.html',
  styleUrls: ['./jurnal-penyetoran.component.scss']
})
export class JurnalPenyetoranComponent implements OnInit, OnDestroy {
