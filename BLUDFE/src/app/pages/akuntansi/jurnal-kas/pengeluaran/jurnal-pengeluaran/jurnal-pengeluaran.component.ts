...
@Component({
  selector: 'app-jurnal-pengeluaran',
  templateUrl: './jurnal-pengeluaran.component.html',
  styleUrls: ['./jurnal-pengeluaran.component.scss']
})
export class JurnalPengeluaranComponent implements OnInit, OnDestroy {
