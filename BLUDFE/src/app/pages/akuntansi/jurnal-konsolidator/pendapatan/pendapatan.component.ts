...
export class PendapatanComponent implements OnInit, OnDestroy {
  ...
  update(e: any){
    this.Form.forms.patchValue({
      idbku : e.IDBKUD,
      nobkukas : e.NOBUKAS,
      tglkas : e.TGLKAS ? new Date(e.TGLKAS) : null,
      nobukti: e.NOBUKTI,
      nmbukti: e.NMBUKTI,
      idref : e.IDSTS,
      uraian : e.URAIAN,
    ...
    this.Form.uiRef = {kode: e.NOSTS, nama: new Date(e.TGLSTS).toLocaleDateString('en-US')};
    console.log(e);
    this.Form.title = 'Edit Jurnal Konsolidator Pendapatan';
    this.Form.titleRef = 'STS';
    this.Form.mode = 'edit';
  ...
  detail(e: any){
    ...
    this.Details.title = 'Ayat - Ayat Jurnal Konsolidator Pendapatan';
