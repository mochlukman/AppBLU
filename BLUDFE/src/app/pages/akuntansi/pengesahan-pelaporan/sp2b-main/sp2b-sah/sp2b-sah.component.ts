...
import {Sp2bSahFormComponent} from 'src/app/pages/akuntansi/pengesahan-pelaporan/sp2b-main/sp2b-sah/sp2b-sah-form/sp2b-sah-form.component';
import _ from 'lodash';

@Component({
  selector: 'app-sp2b-sah',
  templateUrl: './sp2b-sah.component.html',
  styleUrls: ['./sp2b-sah.component.scss']
})
export class Sp2bSahComponent implements OnInit, OnChanges, OnDestroy {
  ...
  @ViewChild(Sp2bSahFormComponent, { static: true }) Form: Sp2bSahFormComponent;
  ...
  update(e: any){
    this.Form.forms.patchValue({
      ...
      idunit: e.idunit,
      nosp2b: e.nosp2b,
      tglsp2b: e.tglsp2b != null ? new Date(e.tglsp2b) : new Date(),
      uraian: e.uraian,
