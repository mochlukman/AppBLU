...
@Component({
  selector: 'app-beban-form',
  templateUrl: './beban-form.component.html',
  styleUrls: ['./beban-form.component.scss'],
  providers: [ InputRupiahPipe ]
})
export class BebanFormComponent implements OnInit {
  ...
  lookRekening(){
    ...
    this.Rekening.params = {Idjnsakun: '8', Type: 'D'};
