...
import {BebanFormComponent} from 'src/app/pages/akuntansi/salk/lo-lalu/beban/beban-form/beban-form.component';

@Component({
  selector: 'app-beban',
  templateUrl: './beban.component.html',
  styleUrls: ['./beban.component.scss']
})
export class BebanComponent implements OnInit, OnDestroy {
  title: string = '';
  ...
  @ViewChild(BebanFormComponent, { static: true }) Form: BebanFormComponent;
