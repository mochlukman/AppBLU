...
@Component({
  selector: 'app-belanja-form',
  templateUrl: './belanja-form.component.html',
  styleUrls: ['./belanja-form.component.scss'],
  providers: [ InputRupiahPipe ]
})
export class BelanjaFormComponent implements OnInit {
  ...
  lookRekening(){
    ...
    this.Rekening.params = {Idjnsakun: '5', Type: 'D'};
