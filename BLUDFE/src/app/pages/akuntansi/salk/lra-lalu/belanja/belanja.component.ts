...
import {BelanjaFormComponent} from 'src/app/pages/akuntansi/salk/lra-lalu/belanja/belanja-form/belanja-form.component';
...
export class BelanjaComponent implements OnInit, OnDestroy {
  ...
  @ViewChild(BelanjaFormComponent, { static: true }) Form: BelanjaFormComponent;
