...
@Component({
  selector: 'app-pembiayaan-form',
  templateUrl: './pembiayaan-form.component.html',
  styleUrls: ['./pembiayaan-form.component.scss'],
  providers: [ InputRupiahPipe ]
})
export class PembiayaanFormComponent implements OnInit {
  ...
  lookRekening(){
    ...
    this.Rekening.params = {Idjnsakun: '6', Type: 'D'};
