...
import {PembiayaanFormComponent} from 'src/app/pages/akuntansi/salk/lra-lalu/pembiayaan/pembiayaan-form/pembiayaan-form.component';
...
export class PembiayaanComponent implements OnInit, OnDestroy {
  ...
  @ViewChild(PembiayaanFormComponent, { static: true }) Form: PembiayaanFormComponent;
