...
@Component({
  selector: 'app-pendapatan-form',
  templateUrl: './pendapatan-form.component.html',
  styleUrls: ['./pendapatan-form.component.scss'],
  providers: [ InputRupiahPipe ]
})
export class PendapatanFormComponent implements OnInit {
  ...
  lookRekening(){
    ...
    this.Rekening.params = {Idjnsakun: '4', Type: 'D'}
