...
import {LookDafrekByJnsakunComponent} from 'src/app/shared/lookups/look-dafrek-by-jnsakun/look-dafrek-by-jnsakun.component';

@Component({
  selector: 'app-saldo-awal-neraca-form',
  templateUrl: './saldo-awal-neraca-form.component.html',
  styleUrls: ['./saldo-awal-neraca-form.component.scss'],
  providers: [ InputRupiahPipe ]
})
export class SaldoAwalNeracaFormComponent implements OnInit {
  ...
  @ViewChild(LookDafrekByJnsakunComponent,{static: true}) Rekening : LookDafrekByJnsakunComponent;
  constructor(
  ...
  lookRekening(){
    ...
    this.Rekening.params = {Idjnsakun: '1,2,3', Type: 'D'};
