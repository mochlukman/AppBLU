...
@Component({
  selector: 'app-penyetoran-pajak-form-sah',
  templateUrl: './penyetoran-pajak-form-sah.component.html',
  styleUrls: ['./penyetoran-pajak-form-sah.component.scss']
})
export class PenyetoranPajakFormSahComponent implements OnInit {
  showThis: boolean;
