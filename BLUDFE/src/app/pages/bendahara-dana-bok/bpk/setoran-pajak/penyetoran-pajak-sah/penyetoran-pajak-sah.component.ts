...
} from 'src/app/pages/bendahara-dana-bok/bpk/setoran-pajak/penyetoran-pajak-sah/penyetoran-pajak-form-sah/penyetoran-pajak-form-sah.component';

@Component({
  selector: 'app-penyetoran-pajak-sah',
  templateUrl: './penyetoran-pajak-sah.component.html',
  styleUrls: ['./penyetoran-pajak-sah.component.scss']
})
export class PenyetoranPajakSahComponent implements OnInit, OnChanges, OnDestroy {
  ...
  @ViewChild(PenyetoranPajakFormSahComponent, {static: true}) Form: PenyetoranPajakFormSahComponent;
