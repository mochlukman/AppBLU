...
} from 'src/app/shared/lookups/look-pungutan-pajak-checkbox/look-pungutan-pajak-checkbox.component';
...
} from 'src/app/pages/bendahara-dana-bok/bpk/setoran-pajak/penyetoran-pajak/penyetoran-pajak-rincian/penyetoran-pajak-rincian-detail/penyetoran-pajak-rincian-detail-form/penyetoran-pajak-rincian-detail-form.component';
import {
  PembuatanBpkPungutanPajakDetComponent
} from 'src/app/pages/bendahara-dana-bok/bpk/bpk/pembuatan-bpk/pembuatan-bpk-rincian/pembuatan-bpk-pungutan-pajak/pembuatan-bpk-pungutan-pajak-det/pembuatan-bpk-pungutan-pajak-det.component';
...
export class PenyetoranPajakRincianDetailComponent implements OnInit, OnChanges, OnDestroy {
  ...
  add(){
    ...
    this.BpkPajak._idbend = this.bpkpajakstrSelected.idbend;
