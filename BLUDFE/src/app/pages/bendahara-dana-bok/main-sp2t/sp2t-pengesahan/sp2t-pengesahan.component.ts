...
} from 'src/app/pages/bendahara-dana-bok/main-sp2t/sp2t-pengesahan/sp2t-form-pengesahan/sp2t-form-pengesahan.component';

@Component({
  selector: 'app-sp2t-pengesahan',
  templateUrl: './sp2t-pengesahan.component.html',
  styleUrls: ['./sp2t-pengesahan.component.scss']
})
export class Sp2tPengesahanComponent implements OnInit, OnDestroy {
  ...
  @ViewChild(Sp2tFormPengesahanComponent, {static: true}) Form: Sp2tFormPengesahanComponent;
  ...
  update(e: ISkp){
    ...
    this.Form.title = 'Pengesahan SP2T';
    this.Form.mode = 'edit';
  ...
  delete(e: ISkp){
    ...
    this.notif.confir({
      message: `Batalkan Pengesahan Untuk No SP2T : ${e.noskp} ?`,
      accept: () => {
