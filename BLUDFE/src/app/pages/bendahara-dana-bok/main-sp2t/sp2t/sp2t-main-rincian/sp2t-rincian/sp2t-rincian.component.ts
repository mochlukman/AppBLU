...
} from 'src/app/pages/bendahara-dana-bok/main-sp2t/sp2t/sp2t-main-rincian/sp2t-rincian-form/sp2t-rincian-form.component';

@Component({
  selector: 'app-sp2t-rincian',
  templateUrl: './sp2t-rincian.component.html',
  styleUrls: ['./sp2t-rincian.component.scss']
})
export class Sp2tRincianComponent implements OnInit, OnChanges, OnDestroy {
  loading: boolean;
  listdata: ISkpdet[] = [];
  @Input() SkpSelected : ISkp;
  userInfo: ITokenClaim;
  @ViewChild(Sp2tRincianFormComponent, {static: true}) Form : Sp2tRincianFormComponent;
