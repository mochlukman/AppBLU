...
@Component({
  selector: 'app-pengesahan-pergeseran-uang-form',
  templateUrl: './pengesahan-pergeseran-uang-form.component.html',
  styleUrls: ['./pengesahan-pergeseran-uang-form.component.scss']
})
export class PengesahanPergeseranUangFormComponent implements OnInit {
  showThis: boolean;
  ...
  getStattrs(){
    ...
    this.stattrsService.getBylist('85,86')
      .subscribe(resp => {
