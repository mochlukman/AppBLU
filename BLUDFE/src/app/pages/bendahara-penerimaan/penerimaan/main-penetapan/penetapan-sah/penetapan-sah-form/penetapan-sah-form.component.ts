...
@Component({
  selector: 'app-penetapan-sah-form',
  templateUrl: './penetapan-sah-form.component.html',
  styleUrls: ['./penetapan-sah-form.component.scss']
})
export class PenetapanSahFormComponent implements OnInit {
