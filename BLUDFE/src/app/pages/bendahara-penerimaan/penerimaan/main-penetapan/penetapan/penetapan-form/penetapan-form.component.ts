...
export class PenetapanFormComponent implements OnInit {
  ...
  changeStattrs(e: any){
    if(e.value){
      this.service.getNoreg({'Idunit': this.forms.value.idunit, 'kdstatus': '61,64'}).subscribe(resp => {
  ...
  lookSKP(){
    ...
    this.Skp.listSkptbpIdsExisting = this.listSkptbpIdsExisting;
