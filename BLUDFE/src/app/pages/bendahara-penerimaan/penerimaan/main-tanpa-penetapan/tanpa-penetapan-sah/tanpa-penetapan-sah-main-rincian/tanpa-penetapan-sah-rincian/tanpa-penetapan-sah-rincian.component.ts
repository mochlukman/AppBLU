...
@Component({
  selector: 'app-tanpa-penetapan-sah-rincian',
  templateUrl: './tanpa-penetapan-sah-rincian.component.html',
  styleUrls: ['./tanpa-penetapan-sah-rincian.component.scss']
})
export class TanpaPenetapanSahRincianComponent implements OnInit, OnChanges, OnDestroy {
  loading: boolean;
  listdata: ITbpdetd[] = [];
