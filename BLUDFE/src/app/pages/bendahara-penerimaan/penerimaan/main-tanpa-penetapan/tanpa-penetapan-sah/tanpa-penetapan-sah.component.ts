...
import { TanpaPenetapanSahFormComponent } from './tanpa-penetapan-sah-form/tanpa-penetapan-sah-form.component';

@Component({
  selector: 'app-tanpa-penetapan-sah',
  templateUrl: './tanpa-penetapan-sah.component.html',
  styleUrls: ['./tanpa-penetapan-sah.component.scss']
})
export class TanpaPenetapanSahComponent implements OnInit, OnDestroy {
  ...
  @ViewChild(TanpaPenetapanSahFormComponent, {static: true}) Form: TanpaPenetapanSahFormComponent;
  ...
  get(){
    ...
    if(this.unitSelected){
      ...
      this.loading = true;
      this.service.gets(this.unitSelected.idunit, '60,63', 1, 0)
        .subscribe(resp => {
          if(resp.length > 0){
            this.listdata = [...resp];
          } else {
