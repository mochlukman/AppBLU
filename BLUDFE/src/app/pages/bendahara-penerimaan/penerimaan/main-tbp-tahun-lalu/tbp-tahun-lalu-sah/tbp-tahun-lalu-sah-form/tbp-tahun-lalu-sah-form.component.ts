...
@Component({
  selector: 'app-tbp-tahun-lalu-sah-form',
  templateUrl: './tbp-tahun-lalu-sah-form.component.html',
  styleUrls: ['./tbp-tahun-lalu-sah-form.component.scss']
})
export class TbpTahunLaluSahFormComponent implements OnInit {
  showThis: boolean;
