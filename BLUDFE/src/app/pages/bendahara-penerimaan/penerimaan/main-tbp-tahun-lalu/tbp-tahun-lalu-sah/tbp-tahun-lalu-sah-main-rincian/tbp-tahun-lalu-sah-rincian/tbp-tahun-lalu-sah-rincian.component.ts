...
@Component({
  selector: 'app-tbp-tahun-lalu-sah-rincian',
  templateUrl: './tbp-tahun-lalu-sah-rincian.component.html',
  styleUrls: ['./tbp-tahun-lalu-sah-rincian.component.scss']
})
export class TbpTahunLaluSahRincianComponent implements OnInit, OnChanges, OnDestroy {
  loading: boolean;
  listdata: ITbpdetd[] = [];
