...
} from 'src/app/pages/bendahara-penerimaan/penerimaan/main-tbp-tahun-lalu/tbp-tahun-lalu-sah/tbp-tahun-lalu-sah-form/tbp-tahun-lalu-sah-form.component';

@Component({
  selector: 'app-tbp-tahun-lalu-sah',
  templateUrl: './tbp-tahun-lalu-sah.component.html',
  styleUrls: ['./tbp-tahun-lalu-sah.component.scss']
})
export class TbpTahunLaluSahComponent implements OnInit, OnDestroy {
  ...
  @ViewChild(TbpTahunLaluSahFormComponent, {static: true}) Form: TbpTahunLaluSahFormComponent;
  ...
  get(){
    ...
    if(this.unitSelected){
      ...
      this.loading = true;
      this.service.gets(this.unitSelected.idunit, '62,65', 1, 0)
        .subscribe(resp => {
          if(resp.length > 0){
            this.listdata = [...resp];
          } else {
  ...
  update(e: ITbp){
    ...
    this.Form.title = 'Pengesahan TBP Tahun Lalu';
    this.Form.mode = 'edit';
