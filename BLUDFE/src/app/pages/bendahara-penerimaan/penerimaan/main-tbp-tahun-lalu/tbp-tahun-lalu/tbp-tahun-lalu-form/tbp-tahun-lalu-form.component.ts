...
@Component({
  selector: 'app-tbp-tahun-lalu-form',
  templateUrl: './tbp-tahun-lalu-form.component.html',
  styleUrls: ['./tbp-tahun-lalu-form.component.scss']
})
export class TbpTahunLaluFormComponent implements OnInit {
  showThis: boolean;
  ...
  getStattrs(){
    ...
    this.stattrsService.getBylist('62,65')
      .subscribe(resp => {
  ...
  changeStattrs(e: any){
    if(e.value){
      this.service.getNoreg({'Idunit': this.forms.value.idunit, 'kdstatus': '62,65'}).subscribe(resp => {
