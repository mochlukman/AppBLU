...
} from 'src/app/pages/bendahara-penerimaan/penerimaan/main-tbp-tahun-lalu/tbp-tahun-lalu/tbp-tahun-lalu-main-rincian/tbp-tahun-lalu-rincian-form/tbp-tahun-lalu-rincian-form.component';

@Component({
  selector: 'app-tbp-tahun-lalu-rincian',
  templateUrl: './tbp-tahun-lalu-rincian.component.html',
  styleUrls: ['./tbp-tahun-lalu-rincian.component.scss']
})
export class TbpTahunLaluRincianComponent implements OnInit, OnChanges, OnDestroy {
  loading: boolean;
  listdata: ITbpdetd[] = [];
  @Input() TbpSelected : ITbp;
  userInfo: ITokenClaim;
  @ViewChild(TbpTahunLaluRincianFormComponent, {static: true}) Form : TbpTahunLaluRincianFormComponent;
