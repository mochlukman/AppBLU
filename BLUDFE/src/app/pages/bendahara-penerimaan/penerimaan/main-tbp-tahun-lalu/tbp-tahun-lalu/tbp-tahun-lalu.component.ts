...
} from 'src/app/pages/bendahara-penerimaan/penerimaan/main-tbp-tahun-lalu/tbp-tahun-lalu/tbp-tahun-lalu-form/tbp-tahun-lalu-form.component';

@Component({
  selector: 'app-tbp-tahun-lalu',
  templateUrl: './tbp-tahun-lalu.component.html',
  styleUrls: ['./tbp-tahun-lalu.component.scss']
})
export class TbpTahunLaluComponent implements OnInit, OnDestroy {
  ...
  @ViewChild(TbpTahunLaluFormComponent, {static: true}) Form: TbpTahunLaluFormComponent;
  ...
  add(){
    if(this.unitSelected){
      this.Form.title = 'Tambah TBP Tahun Lalu';
      this.Form.mode = 'add';
  ...
  update(e: ITbp){
    ...
    this.Form.title = 'Ubah TBP Tahun Lalu';
    this.Form.mode = 'edit';
    this.Form.showThis = true;
  }
  delete(e: ITbp){
