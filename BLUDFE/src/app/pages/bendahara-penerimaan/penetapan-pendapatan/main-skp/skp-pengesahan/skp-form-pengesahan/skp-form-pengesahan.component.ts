...
@Component({
  selector: 'app-skp-form-pengesahan',
  templateUrl: './skp-form-pengesahan.component.html',
  styleUrls: ['./skp-form-pengesahan.component.scss'],
  providers: [ InputRupiahPipe ]
})
export class SkpFormPengesahanComponent implements OnInit {
  showThis: boolean;
