...
@Component({
  selector: 'app-skp-rincian-pengesahan',
  templateUrl: './skp-rincian-pengesahan.component.html',
  styleUrls: ['./skp-rincian-pengesahan.component.scss']
})
export class SkpRincianPengesahanComponent implements OnInit, OnDestroy, OnChanges {
  loading: boolean;
  listdata: ISkpdet[] = [];
