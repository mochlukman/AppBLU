...
@Component({
  selector: 'app-pendapatan-pengesahan-pembebanan',
  templateUrl: './pendapatan-pengesahan-pembebanan.component.html',
  styleUrls: ['./pendapatan-pengesahan-pembebanan.component.scss']
})
export class PendapatanPengesahanPembebananComponent implements OnInit, OnChanges, OnDestroy {
  loading: boolean;
  listdata: Ispmdetd[] = [];
