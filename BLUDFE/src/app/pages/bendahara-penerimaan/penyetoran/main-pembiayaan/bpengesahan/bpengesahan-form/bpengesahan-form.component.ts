...
@Component({
  selector: 'app-bpengesahan-form',
  templateUrl: './bpengesahan-form.component.html',
  styleUrls: ['./bpengesahan-form.component.scss']
})
export class BpengesahanFormComponent implements OnInit {
  showThis: boolean;
