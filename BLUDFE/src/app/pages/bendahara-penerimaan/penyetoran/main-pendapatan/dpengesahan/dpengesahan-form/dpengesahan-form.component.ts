...
@Component({
  selector: 'app-dpengesahan-form',
  templateUrl: './dpengesahan-form.component.html',
  styleUrls: ['./dpengesahan-form.component.scss']
})
export class DpengesahanFormComponent implements OnInit {
  showThis: boolean;
  ...
  getStattrs(){
    ...
    this.stattrsService.getBylist('60,61,62,63,64,65')
      .subscribe(resp => {
