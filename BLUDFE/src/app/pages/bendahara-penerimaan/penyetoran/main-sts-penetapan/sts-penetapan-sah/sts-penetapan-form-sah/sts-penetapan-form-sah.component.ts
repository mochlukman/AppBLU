...
@Component({
  selector: 'app-sts-penetapan-form-sah',
  templateUrl: './sts-penetapan-form-sah.component.html',
  styleUrls: ['./sts-penetapan-form-sah.component.scss']
})
export class StsPenetapanFormSahComponent implements OnInit {
  showThis: boolean;
