...
@Component({
  selector: 'app-sts-penetapan-rincian-sah',
  templateUrl: './sts-penetapan-rincian-sah.component.html',
  styleUrls: ['./sts-penetapan-rincian-sah.component.scss']
})
export class StsPenetapanRincianSahComponent implements OnInit, OnChanges, OnDestroy {
  tabIndex: number = 0;
