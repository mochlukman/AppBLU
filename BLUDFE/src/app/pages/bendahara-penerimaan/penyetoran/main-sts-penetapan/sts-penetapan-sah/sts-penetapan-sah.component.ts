...
} from 'src/app/pages/bendahara-penerimaan/penyetoran/main-sts-penetapan/sts-penetapan-sah/sts-penetapan-form-sah/sts-penetapan-form-sah.component';

@Component({
  selector: 'app-sts-penetapan-sah',
  templateUrl: './sts-penetapan-sah.component.html',
  styleUrls: ['./sts-penetapan-sah.component.scss']
})
export class StsPenetapanSahComponent implements OnInit, OnDestroy {
  ...
  @ViewChild(StsPenetapanFormSahComponent, {static: true}) Form: StsPenetapanFormSahComponent;
