...
@Component({
  selector: 'app-sts-penetapan-rekening-form',
  templateUrl: './sts-penetapan-rekening-form.component.html',
  styleUrls: ['./sts-penetapan-rekening-form.component.scss'],
  providers: [ InputRupiahPipe ]
})
export class StsPenetapanRekeningFormComponent implements OnInit {
  ...
  lookDpar(){
    ...
    this.Dpad.gets({Idunit : this.forms.value.idunit, Idsts : this.forms.value.idsts});
