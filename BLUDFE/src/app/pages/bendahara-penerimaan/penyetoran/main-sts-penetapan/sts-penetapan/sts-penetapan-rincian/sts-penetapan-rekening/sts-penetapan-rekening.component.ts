...
} from 'src/app/pages/bendahara-penerimaan/penyetoran/main-sts-penetapan/sts-penetapan/sts-penetapan-rincian/sts-penetapan-rekening-form/sts-penetapan-rekening-form.component';

@Component({
  selector: 'app-sts-penetapan-rekening',
  templateUrl: './sts-penetapan-rekening.component.html',
  styleUrls: ['./sts-penetapan-rekening.component.scss']
})
export class StsPenetapanRekeningComponent implements OnInit, OnChanges, OnDestroy {
  loading: boolean;
  listdata: IStsdetd[] = [];
  @Input() StsSelected : ISts;
  userInfo: ITokenClaim;
  @ViewChild(StsPenetapanRekeningFormComponent, {static: true}) Form : StsPenetapanRekeningFormComponent;
