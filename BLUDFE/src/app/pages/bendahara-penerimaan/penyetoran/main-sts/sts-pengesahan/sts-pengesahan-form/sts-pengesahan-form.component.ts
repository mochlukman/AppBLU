...
@Component({
  selector: 'app-sts-pengesahan-form',
  templateUrl: './sts-pengesahan-form.component.html',
  styleUrls: ['./sts-pengesahan-form.component.scss']
})
export class StsPengesahanFormComponent implements OnInit {
  showThis: boolean;
