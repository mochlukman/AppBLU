...
import { StsPengesahanFormComponent } from './sts-pengesahan-form/sts-pengesahan-form.component';

@Component({
  selector: 'app-sts-pengesahan',
  templateUrl: './sts-pengesahan.component.html',
  styleUrls: ['./sts-pengesahan.component.scss']
})
export class StsPengesahanComponent implements OnInit, OnDestroy {
  ...
  @ViewChild(StsPengesahanFormComponent, {static: true}) Form: StsPengesahanFormComponent;
  ...
  get(){
    ...
    if(this.unitSelected){
      ...
      this.loading = true;
      this.service.gets(this.unitSelected.idunit, 0, '16', 1, )
        .subscribe(resp => {
          if(resp.length > 0){
            this.listdata = [...resp];
          } else {
