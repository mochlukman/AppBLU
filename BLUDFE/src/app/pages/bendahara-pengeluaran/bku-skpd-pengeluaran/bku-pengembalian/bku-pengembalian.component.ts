...
import { BkuPengembalianFormComponent } from './bku-pengembalian-form/bku-pengembalian-form.component';

@Component({
  selector: 'app-bku-pengembalian',
  templateUrl: './bku-pengembalian.component.html',
  styleUrls: ['./bku-pengembalian.component.scss']
})
export class BkuPengembalianComponent implements OnInit, OnDestroy {
  ...
  @ViewChild(BkuPengembalianFormComponent, {static: true}) Form: BkuPengembalianFormComponent;
  constructor(
      ...
      this.service.generateNoBku(this.formFilter.value.idunit, this.formFilter.value.idbend)
        .subscribe(resp => {
          if(resp.nobku){
            ...
            this.Form.title = 'Tambah BKU Pengembalian';
            this.Form.mode = 'add';
