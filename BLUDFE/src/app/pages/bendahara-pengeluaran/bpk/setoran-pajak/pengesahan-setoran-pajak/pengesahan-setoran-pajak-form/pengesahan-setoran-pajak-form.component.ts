...
@Component({
  selector: 'app-pengesahan-setoran-pajak-form',
  templateUrl: './pengesahan-setoran-pajak-form.component.html',
  styleUrls: ['./pengesahan-setoran-pajak-form.component.scss']
})
export class PengesahanSetoranPajakFormComponent implements OnInit {
  showThis: boolean;
  ...
  constructor(
    ...
    this.forms = this.fb.group({
      ...
      uraian : '',
      nomor : '',
      tanggal :{value: null, disabled: true},
  ...
  simpan(){
    if(this.forms.valid){
      ...
      this.forms.controls['tanggal'].enable();
      if(this.mode === 'edit'){
  ...
  onHide(){
    ...
    this.forms.controls['tanggal'].disable();
    this.msg = [];
    this.loading_post = false;
