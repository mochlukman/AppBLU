...
} from 'src/app/pages/bendahara-pengeluaran/bpk/bpk/pengesahan-bpk/pengesahan-bpk-rincian/pengesahan-bpk-pungutan-pajak/pengesahan-bpk-pungutan-pajak-det/pengesahan-bpk-pungutan-pajak-det.component';

@Component({
  selector: 'app-pengesahan-setoran-pajak-rincian-detail',
  templateUrl: './pengesahan-setoran-pajak-rincian-detail.component.html',
  styleUrls: ['./pengesahan-setoran-pajak-rincian-detail.component.scss']
})
export class PengesahanSetoranPajakRincianDetailComponent implements OnInit, OnChanges, OnDestroy {
