...
@Component({
  selector: 'app-tagihan-pembuatan',
  templateUrl: './tagihan-pembuatan.component.html',
  styleUrls: ['./tagihan-pembuatan.component.scss']
})
export class TagihanPembuatanComponent implements OnInit, OnDestroy {
  ...
  @ViewChild(TagihanPembuatanFormComponent, {static: true}) Form: TagihanPembuatanFormComponent;
