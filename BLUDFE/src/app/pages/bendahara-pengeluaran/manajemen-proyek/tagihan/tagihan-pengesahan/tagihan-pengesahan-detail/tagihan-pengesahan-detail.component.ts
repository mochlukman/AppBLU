...
@Component({
  selector: 'app-tagihan-pengesahan-detail',
  templateUrl: './tagihan-pengesahan-detail.component.html',
  styleUrls: ['./tagihan-pengesahan-detail.component.scss']
})
export class TagihanPengesahanDetailComponent implements OnInit, OnDestroy, OnChanges {
  loading: boolean;
