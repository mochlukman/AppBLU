...
@Component({
  selector: 'app-pelbank-bp-to-bp-form-sah',
  templateUrl: './pelbank-bp-to-bp-form-sah.component.html',
  styleUrls: ['./pelbank-bp-to-bp-form-sah.component.scss']
})
export class PelbankBpToBpFormSahComponent implements OnInit {
  showThis: boolean;
