...
@Component({
  selector: 'app-peltu-bp-to-bp-detail-penerima-sah',
  templateUrl: './peltu-bp-to-bp-detail-penerima-sah.component.html',
  styleUrls: ['./peltu-bp-to-bp-detail-penerima-sah.component.scss']
})
export class PeltuBpToBpDetailPenerimaSahComponent implements OnInit, OnDestroy {
  loading: boolean;
  listdata: ITbpdett[] = [];
