...
} from 'src/app/pages/bendahara-pengeluaran/pelimpahan/pelimpahan-tunai/peltu-bp-to-bp-sah/peltu-bp-to-bp-form-sah/peltu-bp-to-bp-form-sah.component';

@Component({
  selector: 'app-peltu-bp-to-bp-sah',
  templateUrl: './peltu-bp-to-bp-sah.component.html',
  styleUrls: ['./peltu-bp-to-bp-sah.component.scss']
})
export class PeltuBpToBpSahComponent implements OnInit, OnDestroy {
  ...
  @ViewChild(PeltuBpToBpFormSahComponent, {static: true}) Form: PeltuBpToBpFormSahComponent;
