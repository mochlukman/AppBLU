...
@Component({
  selector: 'app-spm-ls-pegawai-potongan-form',
  templateUrl: './spm-ls-pegawai-potongan-form.component.html',
  styleUrls: ['./spm-ls-pegawai-potongan-form.component.scss'],
  providers: [ InputRupiahPipe ]
})
export class SpmLsPegawaiPotonganFormComponent implements OnInit {
