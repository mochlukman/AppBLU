...
@Component({
  selector: 'app-spm-ls-pegawai-potongan-tolak',
  templateUrl: './spm-ls-pegawai-potongan-tolak.component.html',
  styleUrls: ['./spm-ls-pegawai-potongan-tolak.component.scss']
})
export class SpmLsPegawaiPotonganTolakComponent implements OnInit, OnDestroy {
  tabIndex: number = 0;
