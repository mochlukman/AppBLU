...
export class SpmLsUangmukaPembuatanComponent implements OnInit, OnDestroy, OnChanges {
          ...
          if(resp.noreg){
            ...
            .subscribe(resp => {
              this.Form.forms.patchValue({
                ...
                nospm: `${noreg}/S-OPD-${resp.lblstatus}/${this.unitSelected.kdunit}/${this.userInfo.NmTahun}`,
                noreg: noreg
              });
              this.Form.nmstatus = resp.lblstatus.trim();
              this.Form.title = 'Tambah S-OPD - LS Uang Muka';
              this.Form.mode = 'add';
  ...
  update(e: ISpm){
    ...
    if(e.idsppNavigation){
      ...
      if(e.idsppNavigation.idspdNavigation){
        this.Form.forms.patchValue({
          ...
          tglspd: e.idsppNavigation.idspdNavigation.tglspd != null ? new Date(e.idsppNavigation.idspdNavigation.tglspd).toLocaleDateString('en-US') : '',
        });
      }
    }
    ...
    this.Form.title = 'Ubah S-OPD - LS Uang Muka';
    this.Form.mode = 'edit';
  ...
  lookTracking(e: ISpm){
    this.Tracking.title = `Status Data S-OPD : ${e.nospm}`;
