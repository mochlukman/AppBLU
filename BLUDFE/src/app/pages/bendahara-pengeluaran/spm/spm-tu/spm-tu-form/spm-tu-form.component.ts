...
export class SpmTuFormComponent implements OnInit {
  ...
  callbackSpp(e: ISpp){
    ...
    this.forms.patchValue({
      ...
      tglspd: this.sppSelected.idspdNavigation.tglspd != null ? new Date(this.sppSelected.idspdNavigation.tglspd).toLocaleDateString('en-US') : '',
