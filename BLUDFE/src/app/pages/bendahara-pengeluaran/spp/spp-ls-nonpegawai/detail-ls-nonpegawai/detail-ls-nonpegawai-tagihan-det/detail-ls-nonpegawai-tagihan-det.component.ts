...
@Component({
  selector: 'app-detail-ls-nonpegawai-tagihan-det',
  templateUrl: './detail-ls-nonpegawai-tagihan-det.component.html',
  styleUrls: ['./detail-ls-nonpegawai-tagihan-det.component.scss']
})
export class DetailLsNonpegawaiTagihanDetComponent implements OnInit, OnChanges, OnDestroy {
  loading: boolean;
