...
@Component({
  selector: 'app-spp-ls-nonpegawai-potongan-form',
  templateUrl: './spp-ls-nonpegawai-potongan-form.component.html',
  styleUrls: ['./spp-ls-nonpegawai-potongan-form.component.scss'],
  providers: [ InputRupiahPipe ]
})
export class SppLsNonpegawaiPotonganFormComponent implements OnInit {
