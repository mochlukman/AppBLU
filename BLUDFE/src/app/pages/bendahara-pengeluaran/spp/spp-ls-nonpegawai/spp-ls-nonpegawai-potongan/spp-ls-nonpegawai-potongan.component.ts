...
} from 'src/app/pages/bendahara-pengeluaran/spp/spp-ls-nonpegawai/spp-ls-nonpegawai-potongan-form/spp-ls-nonpegawai-potongan-form.component';

@Component({
  selector: 'app-spp-ls-nonpegawai-potongan',
  templateUrl: './spp-ls-nonpegawai-potongan.component.html',
  styleUrls: ['./spp-ls-nonpegawai-potongan.component.scss']
})
export class SppLsNonpegawaiPotonganComponent implements OnInit, OnDestroy {
  ...
  @ViewChild(SppLsNonpegawaiPotonganFormComponent,{static: true}) Form : SppLsNonpegawaiPotonganFormComponent;
