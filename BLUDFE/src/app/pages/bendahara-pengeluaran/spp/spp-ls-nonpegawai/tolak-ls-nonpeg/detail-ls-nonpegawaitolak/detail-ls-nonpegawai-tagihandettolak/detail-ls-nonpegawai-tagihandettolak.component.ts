...
@Component({
  selector: 'app-detail-ls-nonpegawai-tagihandettolak',
  templateUrl: './detail-ls-nonpegawai-tagihandettolak.component.html',
  styleUrls: ['./detail-ls-nonpegawai-tagihandettolak.component.scss']
})
export class DetailLsNonpegawaiTagihandettolakComponent implements OnInit, OnChanges, OnDestroy {
  loading: boolean;
