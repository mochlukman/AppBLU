...
@Component({
  selector: 'app-detail-ls-nonpegawai-tagihantolak',
  templateUrl: './detail-ls-nonpegawai-tagihantolak.component.html',
  styleUrls: ['./detail-ls-nonpegawai-tagihantolak.component.scss']
})
export class DetailLsNonpegawaiTagihantolakComponent implements OnInit, OnChanges, OnDestroy {
