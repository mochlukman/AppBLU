...
@Component({
  selector: 'app-spp-ls-nonpegawai-potongan-tolak',
  templateUrl: './spp-ls-nonpegawai-potongan-tolak.component.html',
  styleUrls: ['./spp-ls-nonpegawai-potongan-tolak.component.scss']
})
export class SppLsNonpegawaiPotonganTolakComponent implements OnInit {
  tabIndex: number = 0;
