...
@Component({
  selector: 'app-spp-ls-nonpegawai-potongan-ver',
  templateUrl: './spp-ls-nonpegawai-potongan-ver.component.html',
  styleUrls: ['./spp-ls-nonpegawai-potongan-ver.component.scss']
})
export class SppLsNonpegawaiPotonganVerComponent implements OnInit, OnDestroy {
  tabIndex: number = 0;
