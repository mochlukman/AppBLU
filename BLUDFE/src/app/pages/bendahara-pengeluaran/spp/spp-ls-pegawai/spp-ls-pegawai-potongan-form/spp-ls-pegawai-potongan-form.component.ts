...
@Component({
  selector: 'app-spp-ls-pegawai-potongan-form',
  templateUrl: './spp-ls-pegawai-potongan-form.component.html',
  styleUrls: ['./spp-ls-pegawai-potongan-form.component.scss'],
  providers: [ InputRupiahPipe ]
})
export class SppLsPegawaiPotonganFormComponent implements OnInit {
