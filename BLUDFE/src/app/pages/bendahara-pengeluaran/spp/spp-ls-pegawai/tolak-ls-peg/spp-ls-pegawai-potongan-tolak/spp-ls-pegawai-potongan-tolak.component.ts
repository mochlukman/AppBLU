...
@Component({
  selector: 'app-spp-ls-pegawai-potongan-tolak',
  templateUrl: './spp-ls-pegawai-potongan-tolak.component.html',
  styleUrls: ['./spp-ls-pegawai-potongan-tolak.component.scss']
})
export class SppLsPegawaiPotonganTolakComponent implements OnInit, OnDestroy {
  tabIndex: number = 0;
