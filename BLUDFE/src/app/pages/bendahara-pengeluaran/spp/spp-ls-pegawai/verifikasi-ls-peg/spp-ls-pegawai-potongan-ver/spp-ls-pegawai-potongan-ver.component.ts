...
@Component({
  selector: 'app-spp-ls-pegawai-potongan-ver',
  templateUrl: './spp-ls-pegawai-potongan-ver.component.html',
  styleUrls: ['./spp-ls-pegawai-potongan-ver.component.scss']
})
export class SppLsPegawaiPotonganVerComponent implements OnInit, OnDestroy {
  tabIndex: number = 0;
