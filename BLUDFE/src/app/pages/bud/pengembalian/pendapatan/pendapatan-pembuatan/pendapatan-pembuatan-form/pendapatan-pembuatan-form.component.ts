...
export class PendapatanPembuatanFormComponent implements OnInit {
  ...
  callbackSpm(e: ISpm){
    ...
    this.forms.patchValue({
      ...
      idspd: this.spmSelected.idsppNavigation.idspdNavigation ? this.spmSelected.idsppNavigation.idspdNavigation.idspd : 0,
      nospd: this.spmSelected.idsppNavigation.idspdNavigation ? this.spmSelected.idsppNavigation.idspdNavigation.nospd : '',
      tglspd: this.spmSelected.idsppNavigation.idspdNavigation.tglspd != null ? new Date(this.spmSelected.idsppNavigation.idspdNavigation.tglspd).toLocaleDateString('en-US') : '',
