...
@Component({
  selector: 'app-sp2d-ls-pegawai-potongan',
  templateUrl: './sp2d-ls-pegawai-potongan.component.html',
  styleUrls: ['./sp2d-ls-pegawai-potongan.component.scss']
})
export class Sp2dLsPegawaiPotonganComponent implements OnInit, OnDestroy {
  @Input() Sp2dSelected : any;
  tabIndex: number = 0;
  ...
  update(e: any){
    ...
    this.Form.isvalid = this.Sp2dSelected.valid;
    this.Form.showThis = true;
  }
  delete(e: any){
    this.notif.confir({
