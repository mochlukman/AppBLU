...
@Component({
  selector: 'app-sp2d-ls-pegawai-verifikasi-potongan',
  templateUrl: './sp2d-ls-pegawai-verifikasi-potongan.component.html',
  styleUrls: ['./sp2d-ls-pegawai-verifikasi-potongan.component.scss']
})
export class Sp2dLsPegawaiVerifikasiPotonganComponent implements OnInit, OnDestroy {
  tabIndex: number = 0;
