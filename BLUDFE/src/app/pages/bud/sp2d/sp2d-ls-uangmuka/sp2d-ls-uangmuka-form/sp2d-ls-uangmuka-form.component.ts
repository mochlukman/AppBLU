...
export class Sp2dLsUangmukaFormComponent implements OnInit {
  ...
  callbackSpm(e: ISpm){
    ...
    this.forms.patchValue({
      ...
      tglspd: this.spmSelected.idsppNavigation.idspdNavigation.tglspd != null ? new Date(this.spmSelected.idsppNavigation.idspdNavigation.tglspd).toLocaleDateString('en-US') : null,
