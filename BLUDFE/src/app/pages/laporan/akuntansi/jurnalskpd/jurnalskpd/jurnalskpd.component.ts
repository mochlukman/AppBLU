...
@Component({
  selector: 'app-jurnalskpd',
  templateUrl: './jurnalskpd.component.html',
  styleUrls: ['./jurnalskpd.component.scss']
})
export class JurnalskpdComponent implements OnInit , OnDestroy {
