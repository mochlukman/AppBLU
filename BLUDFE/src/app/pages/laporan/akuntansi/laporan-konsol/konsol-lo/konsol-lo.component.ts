...
@Component({
  selector: 'app-konsol-lo',
  templateUrl: './konsol-lo.component.html',
  styleUrls: ['./konsol-lo.component.scss']
})
export class KonsolLoComponent implements OnInit , OnDestroy {
