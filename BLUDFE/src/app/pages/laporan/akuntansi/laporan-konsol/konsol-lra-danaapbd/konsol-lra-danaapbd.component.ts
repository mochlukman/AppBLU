...
@Component({
  selector: 'app-konsol-lra-danaapbd',
  templateUrl: './konsol-lra-danaapbd.component.html',
  styleUrls: ['./konsol-lra-danaapbd.component.scss']
})
export class KonsolLraDanaapbdComponent implements OnInit , OnDestroy {
  ...
  callBackTanggal(e: any){
		if(e.cetak){
				...
				this.parameterReport = {
					...
					FileName: 'Konsolidasilraapbd.rpt',
					Params: {
