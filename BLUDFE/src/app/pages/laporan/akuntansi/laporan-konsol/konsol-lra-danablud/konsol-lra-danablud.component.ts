...
@Component({
  selector: 'app-konsol-lra-danablud',
  templateUrl: './konsol-lra-danablud.component.html',
  styleUrls: ['./konsol-lra-danablud.component.scss']
})
export class KonsolLraDanabludComponent implements OnInit , OnDestroy {
  ...
  callBackTanggal(e: any){
		if(e.cetak){
				...
				this.parameterReport = {
					...
					FileName: 'Konsolidasilrablud.rpt',
					Params: {
