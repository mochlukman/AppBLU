...
@Component({
  selector: 'app-konsol-lra-danabok',
  templateUrl: './konsol-lra-danabok.component.html',
  styleUrls: ['./konsol-lra-danabok.component.scss']
})
export class KonsolLraDanabokComponent implements OnInit , OnDestroy {
  ...
  callBackTanggal(e: any){
		if(e.cetak){
				...
				this.parameterReport = {
					...
					FileName: 'Konsolidasilrabok.rpt',
					Params: {
