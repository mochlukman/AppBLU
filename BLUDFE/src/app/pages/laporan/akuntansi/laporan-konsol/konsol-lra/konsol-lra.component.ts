...
@Component({
  selector: 'app-konsol-lra',
  templateUrl: './konsol-lra.component.html',
  styleUrls: ['./konsol-lra.component.scss']
})
export class KonsolLraComponent implements OnInit , OnDestroy {
