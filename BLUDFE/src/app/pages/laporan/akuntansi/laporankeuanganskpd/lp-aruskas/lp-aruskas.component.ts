...
@Component({
  selector: 'app-lp-aruskas',
  templateUrl: './lp-aruskas.component.html',
  styleUrls: ['./lp-aruskas.component.scss']
})
export class LpAruskasComponent implements OnInit, OnDestroy {
