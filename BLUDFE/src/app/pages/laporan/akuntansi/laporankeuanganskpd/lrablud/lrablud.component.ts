...
@Component({
  selector: 'app-lrablud',
  templateUrl: './lrablud.component.html',
  styleUrls: ['./lrablud.component.scss']
})
export class LrabludComponent implements OnInit , OnDestroy {
