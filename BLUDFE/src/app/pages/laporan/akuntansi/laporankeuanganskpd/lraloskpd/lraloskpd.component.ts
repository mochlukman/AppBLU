...
@Component({
  selector: 'app-lraloskpd',
  templateUrl: './lraloskpd.component.html',
  styleUrls: ['./lraloskpd.component.scss']
})
export class LraloskpdComponent implements OnInit , OnDestroy {
