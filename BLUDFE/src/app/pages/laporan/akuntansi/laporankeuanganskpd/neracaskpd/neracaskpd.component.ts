...
@Component({
  selector: 'app-neracaskpd',
  templateUrl: './neracaskpd.component.html',
  styleUrls: ['./neracaskpd.component.scss']
})
export class NeracaskpdComponent implements OnInit , OnDestroy {
