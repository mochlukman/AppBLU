...
@Component({
  selector: 'app-neracasaldo-saldoakhir',
  templateUrl: './neracasaldo-saldoakhir.component.html',
  styleUrls: ['./neracasaldo-saldoakhir.component.scss']
})
export class NeracasaldoSaldoakhirComponent implements OnInit, OnDestroy {
