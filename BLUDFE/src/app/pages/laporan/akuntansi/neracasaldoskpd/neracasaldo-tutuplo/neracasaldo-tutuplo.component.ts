...
@Component({
  selector: 'app-neracasaldo-tutuplo',
  templateUrl: './neracasaldo-tutuplo.component.html',
  styleUrls: ['./neracasaldo-tutuplo.component.scss']
})
export class NeracasaldoTutuploComponent implements OnInit, OnDestroy {
		...
		if(e.cetak){
			if (!this.unitSelected) {
				...
				this.parameterReport = {
					...
					FileName: 'nrc_saldo_tutuplo.rpt',
					Params: {
