...
@Component({
  selector: 'app-neracasaldo-tutuplra',
  templateUrl: './neracasaldo-tutuplra.component.html',
  styleUrls: ['./neracasaldo-tutuplra.component.scss']
})
export class NeracasaldoTutuplraComponent implements OnInit, OnDestroy {
		...
		if(e.cetak){
			if (!this.unitSelected) {
				...
				this.parameterReport = {
					...
					FileName: 'nrc_saldo_tutuplra.rpt',
					Params: {
