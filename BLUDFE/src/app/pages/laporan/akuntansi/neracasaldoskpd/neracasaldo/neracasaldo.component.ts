...
@Component({
  selector: 'app-neracasaldo',
  templateUrl: './neracasaldo.component.html',
  styleUrls: ['./neracasaldo.component.scss']
})
export class NeracasaldoComponent implements OnInit , OnDestroy {
