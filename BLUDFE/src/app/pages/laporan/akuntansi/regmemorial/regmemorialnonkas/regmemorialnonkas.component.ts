...
@Component({
  selector: 'app-regmemorialnonkas',
  templateUrl: './regmemorialnonkas.component.html',
  styleUrls: ['./regmemorialnonkas.component.scss']
})
export class RegmemorialnonkasComponent implements OnInit, OnDestroy {
