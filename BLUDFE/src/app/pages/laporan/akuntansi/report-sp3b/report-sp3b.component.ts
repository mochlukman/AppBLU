...
@Component({
  selector: 'app-report-sp3b',
  templateUrl: './report-sp3b.component.html',
  styleUrls: ['./report-sp3b.component.scss'],
  providers: [DatePipe]
})
export class ReportSp3bComponent implements OnInit, OnDestroy {
  title: string = '';
  loading_post: boolean;
  uiUnit: IDisplayGlobal;
  uiSp3b: IDisplayGlobal;
  indoKalender: any;
  ...
  @ViewChild(LookSp3bComponent, {static: true}) sp3b : LookSp3bComponent;
  forms: FormGroup;
  initialForm: any;
  constructor(
    ...
    this.uiSp3b = {kode: '', nama: '' };
    this.forms = this.fb.group({
      idunit: [0, [Validators.required, Validators.min(1)]],
      idsp3b: [0, [Validators.required, Validators.min(1)]],
      idbulan: 0,
      tgl: null
    });
  ...
  lookSp3b(){
    if(this.forms.controls['idunit'].valid){
      this.sp3b.title = 'Pilih SP3B';
      this.sp3b.gets({idunit: this.forms.value.idunit});
      this.sp3b.showThis = true;
    } else {
  ...
  callbackSp3b(e: any){
    if(e){
      this.uiSp3b = {kode: e.nosp3b, nama: this.datePipe.transform(e.tglsp3b, 'dd/MM/yyyy')};
    } else {
      this.uiSp3b = {kode: '', nama: '' };
    }
    this.forms.patchValue({
    ...
    if(e.cetak){
      ...
      this.parameterReport = {
        ...
        Params: {
          ...
          '@noSP3B': this.forms.value.nosp3b,
