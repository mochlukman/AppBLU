...
@Component({
  selector: 'app-angkas-perubahan-pendapatan',
  templateUrl: './angkas-perubahan-pendapatan.component.html',
  styleUrls: ['./angkas-perubahan-pendapatan.component.scss']
})
export class AngkasPerubahanPendapatanComponent implements OnInit, OnDestroy {
