...
@Component({
  selector: 'app-angkas-pembiayaan',
  templateUrl: './angkas-pembiayaan.component.html',
  styleUrls: ['./angkas-pembiayaan.component.scss']
})
export class AngkasPembiayaanComponent implements OnInit, OnDestroy {
