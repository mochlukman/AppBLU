...
@Component({
  selector: 'app-angkas-pendapatan',
  templateUrl: './angkas-pendapatan.component.html',
  styleUrls: ['./angkas-pendapatan.component.scss']
})
export class AngkasPendapatanComponent implements OnInit, OnDestroy {
  ...
  getTahap(){
      ...
      this.service.getsBykode('321').subscribe(resp => {
		  this.optionTahap = [];
		  if(resp.length > 0){
				resp.forEach(e => {
