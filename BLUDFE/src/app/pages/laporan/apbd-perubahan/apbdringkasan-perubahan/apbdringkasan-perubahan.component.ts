...
@Component({
  selector: 'app-apbdringkasan-perubahan',
  templateUrl: './apbdringkasan-perubahan.component.html',
  styleUrls: ['./apbdringkasan-perubahan.component.scss']
})
export class ApbdringkasanPerubahanComponent implements OnInit, OnDestroy {
