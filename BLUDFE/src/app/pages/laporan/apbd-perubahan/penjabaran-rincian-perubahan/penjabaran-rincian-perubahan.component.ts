...
@Component({
  selector: 'app-penjabaran-rincian-perubahan',
  templateUrl: './penjabaran-rincian-perubahan.component.html',
  styleUrls: ['./penjabaran-rincian-perubahan.component.scss']
})
export class PenjabaranRincianPerubahanComponent implements OnInit , OnDestroy {
