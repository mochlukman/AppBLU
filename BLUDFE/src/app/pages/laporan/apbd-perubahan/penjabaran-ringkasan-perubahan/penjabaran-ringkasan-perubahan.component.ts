...
@Component({
  selector: 'app-penjabaran-ringkasan-perubahan',
  templateUrl: './penjabaran-ringkasan-perubahan.component.html',
  styleUrls: ['./penjabaran-ringkasan-perubahan.component.scss']
})
export class PenjabaranRingkasanPerubahanComponent implements OnInit, OnDestroy {
