...
@Component({
  selector: 'app-bku-dana-bok',
  templateUrl: './bku-dana-bok.component.html',
  styleUrls: ['./bku-dana-bok.component.scss']
})
export class BkuDanaBokComponent  implements OnInit , OnDestroy {
