...
@Component({
  selector: 'app-bpbank-dana-bok',
  templateUrl: './bpbank-dana-bok.component.html',
  styleUrls: ['./bpbank-dana-bok.component.scss']
})
export class BpbankDanaBokComponent  implements OnInit , OnDestroy {
