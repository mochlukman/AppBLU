...
@Component({
  selector: 'app-bpkas-dana-bok',
  templateUrl: './bpkas-dana-bok.component.html',
  styleUrls: ['./bpkas-dana-bok.component.scss']
})
export class BpkasDanaBokComponent  implements OnInit , OnDestroy {
