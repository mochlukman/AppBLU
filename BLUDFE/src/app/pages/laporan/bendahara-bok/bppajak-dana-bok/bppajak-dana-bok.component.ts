...
@Component({
  selector: 'app-bppajak-dana-bok',
  templateUrl: './bppajak-dana-bok.component.html',
  styleUrls: ['./bppajak-dana-bok.component.scss']
})
export class BppajakDanaBokComponent  implements OnInit , OnDestroy {
