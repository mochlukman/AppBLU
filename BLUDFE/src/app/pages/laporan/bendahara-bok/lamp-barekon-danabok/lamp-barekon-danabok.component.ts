...
@Component({
  selector: 'app-lamp-barekon-danabok',
  templateUrl: './lamp-barekon-danabok.component.html',
  styleUrls: ['./lamp-barekon-danabok.component.scss']
})
export class LampBarekonDanabokComponent implements OnInit , OnDestroy {
