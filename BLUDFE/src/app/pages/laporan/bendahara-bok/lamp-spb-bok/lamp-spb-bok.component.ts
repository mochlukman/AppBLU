...
@Component({
  selector: 'app-lamp-spb-bok',
  templateUrl: './lamp-spb-bok.component.html',
  styleUrls: ['./lamp-spb-bok.component.scss']
})
export class LampSpbBokComponent implements OnInit , OnDestroy {
