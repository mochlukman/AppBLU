...
@Component({
  selector: 'app-real-belanja-danabok',
  templateUrl: './real-belanja-danabok.component.html',
  styleUrls: ['./real-belanja-danabok.component.scss']
})
export class RealBelanjaDanabokComponent  implements OnInit , OnDestroy {
