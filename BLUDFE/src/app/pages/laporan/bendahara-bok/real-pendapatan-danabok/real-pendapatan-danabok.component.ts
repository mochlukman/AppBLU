...
@Component({
  selector: 'app-real-pendapatan-danabok',
  templateUrl: './real-pendapatan-danabok.component.html',
  styleUrls: ['./real-pendapatan-danabok.component.scss']
})
export class RealPendapatanDanabokComponent  implements OnInit , OnDestroy {
