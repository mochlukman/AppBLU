...
@Component({
  selector: 'app-sp2b-bok',
  templateUrl: './sp2b-bok.component.html',
  styleUrls: ['./sp2b-bok.component.scss']
})
export class Sp2bBokComponent implements OnInit , OnDestroy {
