...
@Component({
  selector: 'app-buku-terima-setor',
  templateUrl: './buku-terima-setor.component.html',
  styleUrls: ['./buku-terima-setor.component.scss']
})
export class BukuTerimaSetorComponent implements OnInit, OnDestroy {
