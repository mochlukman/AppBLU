...
@Component({
  selector: 'app-registerskp',
  templateUrl: './registerskp.component.html',
  styleUrls: ['./registerskp.component.scss']
})
export class RegisterskpComponent implements OnInit , OnDestroy {
