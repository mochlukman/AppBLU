...
@Component({
  selector: 'app-registertbp',
  templateUrl: './registertbp.component.html',
  styleUrls: ['./registertbp.component.scss']
})
export class RegistertbpComponent implements OnInit, OnDestroy {
