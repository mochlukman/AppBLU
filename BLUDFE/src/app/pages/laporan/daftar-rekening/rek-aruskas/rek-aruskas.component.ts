...
@Component({
  selector: 'app-rek-aruskas',
  templateUrl: './rek-aruskas.component.html',
  styleUrls: ['./rek-aruskas.component.scss']
})
export class RekAruskasComponent  implements OnInit , OnDestroy {
