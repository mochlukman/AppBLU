...
@Component({
  selector: 'app-kas-blud',
  templateUrl: './kas-blud.component.html',
  styleUrls: ['./kas-blud.component.scss']
})
export class KasBludComponent  implements OnInit , OnDestroy {
