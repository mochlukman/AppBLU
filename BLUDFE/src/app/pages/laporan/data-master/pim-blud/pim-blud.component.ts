...
@Component({
  selector: 'app-pim-blud',
  templateUrl: './pim-blud.component.html',
  styleUrls: ['./pim-blud.component.scss']
})
export class PimBludComponent  implements OnInit , OnDestroy {
