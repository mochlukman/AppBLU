...
@Component({
  selector: 'app-ppkunit',
  templateUrl: './ppkunit.component.html',
  styleUrls: ['./ppkunit.component.scss']
})
export class PpkunitComponent  implements OnInit , OnDestroy {
