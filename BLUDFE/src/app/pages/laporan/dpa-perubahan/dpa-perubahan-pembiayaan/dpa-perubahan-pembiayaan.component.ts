...
@Component({
  selector: 'app-dpa-perubahan-pembiayaan',
  templateUrl: './dpa-perubahan-pembiayaan.component.html',
  styleUrls: ['./dpa-perubahan-pembiayaan.component.scss']
})
export class DpaPerubahanPembiayaanComponent implements OnInit, OnDestroy {
