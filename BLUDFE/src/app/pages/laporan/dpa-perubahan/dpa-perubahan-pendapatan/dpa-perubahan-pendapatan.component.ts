...
@Component({
  selector: 'app-dpa-perubahan-pendapatan',
  templateUrl: './dpa-perubahan-pendapatan.component.html',
  styleUrls: ['./dpa-perubahan-pendapatan.component.scss']
})
export class DpaPerubahanPendapatanComponent implements OnInit, OnDestroy {
