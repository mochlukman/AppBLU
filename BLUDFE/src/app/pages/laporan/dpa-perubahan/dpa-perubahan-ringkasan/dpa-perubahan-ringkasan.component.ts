...
@Component({
  selector: 'app-dpa-perubahan-ringkasan',
  templateUrl: './dpa-perubahan-ringkasan.component.html',
  styleUrls: ['./dpa-perubahan-ringkasan.component.scss']
})
export class DpaPerubahanRingkasanComponent implements OnInit, OnDestroy {
