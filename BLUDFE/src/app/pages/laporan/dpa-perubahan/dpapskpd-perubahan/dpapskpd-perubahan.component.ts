...
@Component({
  selector: 'app-dpapskpd-perubahan',
  templateUrl: './dpapskpd-perubahan.component.html',
  styleUrls: ['./dpapskpd-perubahan.component.scss']
})
export class DpapskpdPerubahanComponent implements OnInit, OnDestroy {
