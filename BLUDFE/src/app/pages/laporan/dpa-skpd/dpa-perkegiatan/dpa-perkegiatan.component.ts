...
@Component({
  selector: 'app-dpa-perkegiatan',
  templateUrl: './dpa-perkegiatan.component.html',
  styleUrls: ['./dpa-perkegiatan.component.scss']
})
export class DpaPerkegiatanComponent implements OnInit, OnDestroy {
