...
@Component({
  selector: 'app-kua-progkeg',
  templateUrl: './kua-progkeg.component.html',
  styleUrls: ['./kua-progkeg.component.scss']
})
export class KuaProgkegComponent implements OnInit , OnDestroy {
