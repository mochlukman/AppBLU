...
@Component({
  selector: 'app-lpj-terima-setor',
  templateUrl: './lpj-terima-setor.component.html',
  styleUrls: ['./lpj-terima-setor.component.scss']
})
export class LpjTerimaSetorComponent implements OnInit , OnDestroy {
