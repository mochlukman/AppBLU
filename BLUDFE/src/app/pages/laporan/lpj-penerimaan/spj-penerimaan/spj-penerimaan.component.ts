...
@Component({
  selector: 'app-spj-penerimaan',
  templateUrl: './spj-penerimaan.component.html',
  styleUrls: ['./spj-penerimaan.component.scss']
})
export class SpjPenerimaanComponent implements OnInit , OnDestroy {
