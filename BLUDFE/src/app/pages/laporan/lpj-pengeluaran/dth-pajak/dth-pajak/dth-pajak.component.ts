...
@Component({
  selector: 'app-dth-pajak',
  templateUrl: './dth-pajak.component.html',
  styleUrls: ['./dth-pajak.component.scss']
})

export class DthPajakComponent implements OnInit , OnDestroy {
