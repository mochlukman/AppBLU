...
@Component({
  selector: 'app-map-aruskas',
  templateUrl: './map-aruskas.component.html',
  styleUrls: ['./map-aruskas.component.scss']
})
export class MapAruskasComponent  implements OnInit , OnDestroy {
