...
@Component({
  selector: 'app-map-asetutang',
  templateUrl: './map-asetutang.component.html',
  styleUrls: ['./map-asetutang.component.scss']
})
export class MapAsetutangComponent  implements OnInit , OnDestroy {
		...
		if(e.cetak){
			 {
				...
				this.parameterReport = {
					...
					FileName: 'mapping_aset_utang.rpt',
					Params: {
