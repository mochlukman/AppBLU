...
@Component({
  selector: 'app-map-blnj-asettp',
  templateUrl: './map-blnj-asettp.component.html',
  styleUrls: ['./map-blnj-asettp.component.scss']
})
export class MapBlnjAsettpComponent  implements OnInit , OnDestroy {
		...
		if(e.cetak){
			 {
				...
				this.parameterReport = {
					...
					FileName: 'mapping_aset_modal.rpt',
					Params: {
