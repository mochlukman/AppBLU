...
@Component({
  selector: 'app-map-pendapatan-belanja',
  templateUrl: './map-pendapatan-belanja.component.html',
  styleUrls: ['./map-pendapatan-belanja.component.scss']
})
export class MapPendapatanBelanjaComponent  implements OnInit , OnDestroy {
		...
		if(e.cetak){
			 {
				...
				this.parameterReport = {
					...
					FileName: 'mapping_pendapatan_belanja.rpt',
					Params: {
