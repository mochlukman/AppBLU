...
@Component({
  selector: 'app-map-rbaapbd',
  templateUrl: './map-rbaapbd.component.html',
  styleUrls: ['./map-rbaapbd.component.scss']
})
export class MapRbaapbdComponent  implements OnInit , OnDestroy {
