...
@Component({
  selector: 'app-map-rbalo',
  templateUrl: './map-rbalo.component.html',
  styleUrls: ['./map-rbalo.component.scss']
})
export class MapRbaloComponent  implements OnInit , OnDestroy {
