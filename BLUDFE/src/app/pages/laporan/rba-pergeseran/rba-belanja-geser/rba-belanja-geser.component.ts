...
@Component({
  selector: 'app-rba-belanja-geser',
  templateUrl: './rba-belanja-geser.component.html',
  styleUrls: ['./rba-belanja-geser.component.scss']
})
export class RbaBelanjaGeserComponent implements OnInit , OnDestroy {
  ...
  getTahap(){
    this.service.getsBykode('342,343,344,345,346,347,348,349,350,351').subscribe(resp => {
  ...
  lookKegiatan(){
    if(this.unitSelected){
      ...
      this.Kegiatan._kdtahap = '321';
      this.Kegiatan._type = 'd';
      this.Kegiatan.get();
