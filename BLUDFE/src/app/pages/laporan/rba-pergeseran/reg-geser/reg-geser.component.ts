...
@Component({
  selector: 'app-reg-geser',
  templateUrl: './reg-geser.component.html',
  styleUrls: ['./reg-geser.component.scss']
})
export class RegGeserComponent implements OnInit, OnDestroy {
