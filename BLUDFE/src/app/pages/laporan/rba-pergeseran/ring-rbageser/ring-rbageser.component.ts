...
@Component({
  selector: 'app-ring-rbageser',
  templateUrl: './ring-rbageser.component.html',
  styleUrls: ['./ring-rbageser.component.scss']
})
export class RingRbageserComponent implements OnInit , OnDestroy {
