...
@Component({
  selector: 'app-register-bpk',
  templateUrl: './register-bpk.component.html',
  styleUrls: ['./register-bpk.component.scss']
})
export class RegisterBpkComponent implements OnInit , OnDestroy {
