...
@Component({
  selector: 'app-register-panjar',
  templateUrl: './register-panjar.component.html',
  styleUrls: ['./register-panjar.component.scss']
})
export class RegisterPanjarComponent implements OnInit , OnDestroy {
