...
@Component({
  selector: 'app-register-sopd',
  templateUrl: './register-sopd.component.html',
  styleUrls: ['./register-sopd.component.scss']
})
export class RegisterSopdComponent implements OnInit , OnDestroy {
