...
@Component({
  selector: 'app-register-spd',
  templateUrl: './register-spd.component.html',
  styleUrls: ['./register-spd.component.scss']
})
export class RegisterSpdComponent implements OnInit , OnDestroy {
