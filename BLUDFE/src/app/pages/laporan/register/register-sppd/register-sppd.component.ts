...
@Component({
  selector: 'app-register-sppd',
  templateUrl: './register-sppd.component.html',
  styleUrls: ['./register-sppd.component.scss']
})
export class RegisterSppdComponent implements OnInit , OnDestroy {
