...
@Component({
  selector: 'app-register-tagihan',
  templateUrl: './register-tagihan.component.html',
  styleUrls: ['./register-tagihan.component.scss']
})
export class RegisterTagihanComponent implements OnInit , OnDestroy {
		...
		if(e.cetak){
			if (!this.unitSelected) {
				...
				this.parameterReport = {
					...
					FileName: 'RegBAST.rpt',
					Params: {

						'@IdUnit': this.unitSelected.idunit,
            '@tanggal': (this.tanggal !== null || this.tanggal != '') ? new Date(this.tanggal).toLocaleDateString('en-US', { year: 'numeric', month: '2-digit', day: '2-digit' }) : ''
						//'@tanggal': e.TGL,
						//'@hal':e.halaman
					}
				};
