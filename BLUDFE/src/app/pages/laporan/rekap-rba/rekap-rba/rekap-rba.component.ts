...
@Component({
  selector: 'app-rekap-rba',
  templateUrl: './rekap-rba.component.html',
  styleUrls: ['./rekap-rba.component.scss']
})
export class RekapRbaComponent implements OnInit , OnDestroy {
