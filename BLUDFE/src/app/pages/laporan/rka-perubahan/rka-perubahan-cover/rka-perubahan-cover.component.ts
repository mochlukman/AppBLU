...
@Component({
  selector: 'app-rka-perubahan-cover',
  templateUrl: './rka-perubahan-cover.component.html',
  styleUrls: ['./rka-perubahan-cover.component.scss']
})
export class RkaPerubahanCoverComponent implements OnInit, OnDestroy {
