...
@Component({
  selector: 'app-rka-cover',
  templateUrl: './rka-cover.component.html',
  styleUrls: ['./rka-cover.component.scss']
})
export class RkaCoverComponent implements OnInit  , OnDestroy {
