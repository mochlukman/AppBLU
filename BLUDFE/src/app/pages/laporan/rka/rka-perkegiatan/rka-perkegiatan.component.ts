...
@Component({
  selector: 'app-rka-perkegiatan',
  templateUrl: './rka-perkegiatan.component.html',
  styleUrls: ['./rka-perkegiatan.component.scss']
})
export class RkaPerkegiatanComponent implements OnInit , OnDestroy {
