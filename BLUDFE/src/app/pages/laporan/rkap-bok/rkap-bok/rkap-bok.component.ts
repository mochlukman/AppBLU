...
@Component({
  selector: 'app-rkap-bok',
  templateUrl: './rkap-bok.component.html',
  styleUrls: ['./rkap-bok.component.scss']
})
export class RkapBokComponent implements OnInit , OnDestroy {
