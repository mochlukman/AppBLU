...
@Component({
  selector: 'app-aset-tetap',
  templateUrl: './aset-tetap.component.html',
  styleUrls: ['./aset-tetap.component.scss']
})
export class AsetTetapComponent implements OnInit, OnDestroy {
  loading: boolean;
