...
@Component({
  selector: 'app-kdp-form',
  templateUrl: './kdp-form.component.html',
  styleUrls: ['./kdp-form.component.scss']
})
export class KdpFormComponent implements OnInit {
  showThis: boolean;
  title: string;
  msg: Message[];
  loading: boolean;
