...
@Component({
  selector: 'app-lo-pendapatan',
  templateUrl: './lo-pendapatan.component.html',
  styleUrls: ['./lo-pendapatan.component.scss']
})
export class LoPendapatanComponent implements OnInit, OnDestroy {
  loading: boolean;
