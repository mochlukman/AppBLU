...
import { AsbFormComponent } from './asb-form/asb-form.component';
...
export class AsbComponent implements OnInit, OnDestroy {
  title: string = '';
  ...
  @ViewChild(AsbFormComponent, {static: true}) form: AsbFormComponent;
  constructor(
