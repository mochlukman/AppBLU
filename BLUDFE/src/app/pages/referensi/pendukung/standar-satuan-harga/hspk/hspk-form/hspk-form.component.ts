...
@Component({
  selector: 'app-hspk-form',
  templateUrl: './hspk-form.component.html',
  styleUrls: ['./hspk-form.component.scss'],
  providers: [InputRupiahPipe]
})
export class HspkFormComponent implements OnInit {
  showThis: boolean;
  ...
  constructor(
    ...
    this.forms = this.fb.group({
      ...
      kdsatuan: '',
      harga: 0,
      kelompok: ['2', Validators.required]
    });
