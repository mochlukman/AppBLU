...
import { HspkFormComponent } from './hspk-form/hspk-form.component';
...
export class HspkComponent implements OnInit, OnDestroy {
  title: string = '';
  ...
  @ViewChild(HspkFormComponent, {static: true}) form: HspkFormComponent;
  constructor(
