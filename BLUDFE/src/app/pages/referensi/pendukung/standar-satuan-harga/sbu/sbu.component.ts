...
import { SbuFormComponent } from './sbu-form/sbu-form.component';
...
export class SbuComponent implements OnInit, OnDestroy {
  title: string = '';
  ...
  @ViewChild(SbuFormComponent, {static: true}) form: SbuFormComponent;
  constructor(
