...
@Component({
  selector: 'app-look-dafrek-dpa-spp',
  templateUrl: './look-dafrek-dpa-spp.component.html',
  styleUrls: ['./look-dafrek-dpa-spp.component.scss']
})
export class LookDafrekDpaSppComponent implements OnInit {
  showThis: boolean;
  title: string;
  msg: Message[];
  loading: boolean;
