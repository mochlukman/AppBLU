...
@Component({
  selector: 'app-lookup-kontrak-spp',
  templateUrl: './lookup-kontrak-spp.component.html',
  styleUrls: ['./lookup-kontrak-spp.component.scss']
})
export class LookupKontrakSppComponent implements OnInit {
